 ...
 */
    ...
    self.settings = {
         ...
         *
         * NOTE: Latest versions of Firefox and Chrome will not display
         * the custom message to the player, but will use their own default instead.
         *
         * @public
         * @field
         * @type boolean|string
