...
vorple.core.settings.confirmWindowClose;if(a)a.returnValue=c;return c}};"undefined"===typeof window.console&&(window.console={log:function(){}})};vorple.core.engine=function(a){var b=!!(vorple.core.system&&"function"===typeof vorple.core.system.SimpleSituation),c=!!(vorple.core.system&&"object"===typeof vorple.core.system.vms);if("string"===typeof a)switch(a){case "undum":return b;case "parchment":return c;default:return!1}return!vorple.core.system?null:b?"undum":c?"parchment":!1};vorple.core.generateId=
