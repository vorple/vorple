...
(function(b){vorple.core={release:3,version:1,system:null};vorple.core.defaults={target:"_blank"};vorple.core.settings={confirmWindowClose:!1,debug:!1};vorple.core._init=function(a){"undefined"!==typeof a&&(this.system=a);b(".vorple-version").html(this.version+"."+this.release);window.onbeforeunload=function(a){if(vorple.core.settings.confirmWindowClose&&!vorple.core.settings.debug){var b;b=vorple.core.settings.confirmWindowClose===true?"You are about to leave the story. Any unsaved progress will be lost. Are you sure you want to continue?":
vorple.core.settings.confirmWindowClose;if(a)a.returnValue=b;return b}};"undefined"===typeof window.console&&(window.console={log:function(){}})};vorple.core.engine=function(a){if("string"===typeof a)switch(a){case "undum":return"undefined"!==typeof undum;case "parchment":return"undefined"!==typeof parchment;default:return!1}return"undefined"!==typeof undum?"undum":"undefined"!==typeof parchment?"parchment":null};vorple.core.generateId=function(a){void 0===a&&(a=32);for(var b="",c=0;c<a;++c)var e=
0==c?Math.floor(52*Math.random())+10:Math.floor(62*Math.random()),b=10>e?b+(""+e):36>e?b+String.fromCharCode(e+55):b+String.fromCharCode(e+61);return b};vorple.core.init=function(a){this._init(a);b(document).trigger("vorpleInit")};vorple.core.clickLink=function(a,d){b.extend({},this.defaults,d);this.engine("undum")?this.system.doClick(a):window.location=a};vorple.core.requireRelease=function(a,d){var c,e=!1,f;b.isArray(a)?(c=a[0],e=a[1],f=c+"-"+e):f=c=a;if(c>this.release||!1!==e&&e<this.release)switch(typeof d){case "function":d();
break;case "string":throw Error(d);default:throw Error("Version mismatch: release "+f+" required, currently running release "+this.release);}return!0}})(jQuery);(function(b){vorple.button={};vorple.button.defaults={groupParent:"<div>"};vorple.button.template=function(){this.defaults={classes:""}};vorple.button.template.prototype.init=function(a,d,c){this.opt="object"===typeof c?b.extend({},this.defaults,c):"object"===typeof d?b.extend({},this.defaults,d):b.extend({},this.defaults);this.content="undefined"!==typeof a?a:"";this.idClass="button_"+vorple.core.generateId();this.opt.classes+=" vorpleButton basicButton "+this.idClass;this.options=c;this.element=
this.createElement(a,this.opt);this.onclick="function"===b.type(d)?d:"string"===b.type(d)?function(a){vorple.core.clickLink(d);a.preventDefault()}:b.noop;this.createClickEvent(this.onclick)};vorple.button.template.prototype.createClickEvent=function(a){var d=this;b(document).on("click","."+this.idClass,function(b){d.isEnabled()&&a(b)})};vorple.button.template.prototype.createElement=function(a){return a};vorple.button.template.prototype.disable=b.noop;vorple.button.template.prototype.enable=b.noop;
...
b("body").on("click",".popuplink_"+f,function(a){a.preventDefault();a.stopPropagation();b(".linkPopup").hide();g.appendTo("body").show().offset({left:a.pageX,top:a.pageY})});b("body").on("click",".popup_"+f+" a",function(a){a.preventDefault();vorple.core.clickLink(b(this).attr("href"));b(".linkPopup").hide();return!1});c.classes+="popupLink popuplink_"+f;return vorple.html.link("#",d,c)}return"object"===typeof a?e._createLink(a):e._createLink({url:a,content:d,options:c})};b(document).bind("vorpleInit",
...
(a=!0);this.mute({music:a,sound:a});return a};vorple.media._play=function(a,d){var c=b.extend({},this.defaults,d),e;if(c.onReady)var f=c.onReady;e="undefined"==typeof c.container||!c.container?this._createPlayer(d):c.container;e.jPlayer("destroy");var g={},i=[];b.each(a,function(a,b){g[a]=vorple.html.url(b,c.audioPath);i.push(a)});e.jPlayer({muted:c.muted,preload:"auto",ready:function(){b(this).jPlayer("setMedia",g).jPlayer("play");b.isFunction(f)&&f()},solution:c.solution,supplied:i.join(", "),swfPath:c.swfPath,
...
a+"?version=3",f=b.param(c.parameters);f&&(e+="&"+f);return'<object width="'+c.width+'" height="'+c.height+'"><param name="movie" value="'+e+'"></param><param name="allowScriptAccess" value="always"></param><embed src="'+e+'" type="application/x-shockwave-flash" allowscriptaccess="always" width="'+c.width+'" height="'+c.height+'"></embed></object>'};vorple.media.defaults.youtube={width:640,height:390,parameters:{autoplay:"1",controls:"0",disablekb:"1",modestbranding:"1",rel:"0"}};b(document).bind("vorpleInit",
...
b(this);if(a.val()=="all")vorple.media.muteAll(!a.is(":checked"));else{var c={};c[a.val()]=!a.is(":checked");vorple.media.mute(c)}})})})(jQuery);(function(b){vorple.notify={};vorple.notify.defaults={layout:"bottomRight",timeout:7E3};vorple.notify.clearQueue=function(){b.noty.clearQueue()};vorple.notify.close=function(){b.noty.close()};vorple.notify.closeAll=function(){b.noty.closeAll()};vorple.notify.show=function(a,d){var c=b.extend({},this.defaults,d,{text:a});noty(c)}})(jQuery);(function(b){vorple.parser={_container:{parchment:null,vorple:"#vorple"},_scrollPosition:0,_turn:{commandHidden:!1,outputSilent:!1,type:"normal"}};vorple.parser.hideCommand=function(a){"undefined"===typeof a&&(a=!0);this._turn.commandHidden=a};vorple.parser.sendCommand=function(a,d){var c=b.extend({hideCommand:!1,silenceOutput:!1},d),e=b(".TextInput"),f=e.val();c.silenceOutput&&this.silenceOutput();c.hideCommand&&this.hideCommand();e.val(a).trigger(b.Event("keydown",{which:b.ui.keyCode.ENTER}));c.hideCommand&&
b(".TextInput").val(f)};vorple.parser.setTurnType=function(a){this._turn.type=a};vorple.parser.silenceOutput=function(a){"undefined"===typeof a&&(a=!0);this._turn.outputSilent=a};vorple.parser.setTurnClasses=function(a){a.data("turnType",vorple.parser._turn.type);var d=b(".turnContent",a);switch(vorple.parser._turn.type){case "error":return a.addClass("parserError"),d.addClass("transient"),!1;case "undo":b(".previousTurn .turnContent").animate({opacity:0},1500).slideUp(500),b(".previousTurn").addClass("undoneTurn").removeClass("normalTurn"),
b("<span>").text(" (undone)").addClass("undoClarification").appendTo(b(".previousTurn .oldPrompt")),a.addClass("undoMessage").addClass("transient"),b(".previousTurn").removeClass("previousTurn").prevAll(".normalTurn").first().addClass("previousTurn"),b(".penultimateTurn").removeClass("penultimateTurn").prevAll(".normalTurn").first().addClass("penultimateTurn"),b(".currentPrompt").empty();case "meta":return b("<div>").addClass("metaPopup").html(d.html()).appendTo("body").animate({top:"10",opacity:"1"},
function(){b(this).delay(6E3).animate({top:"-100",opacity:"0"},function(){b(this).remove()})}),a.empty(),!1;case "dialog":return d.clone().dialog({width:600,modal:!0,resizable:!1,title:b(".oldPrompt",a).text()}),a.empty(),!1;default:return a.addClass("normalTurn"),!0}};b(document).bind("vorpleInit",function(){vorple.core.engine("parchment")&&(vorple.parser._container.parchment=vorple.core.system.options.container,b(document).on("click","a.command",function(a){a.preventDefault();vorple.parser.sendCommand(b(this).attr("href"));
return!1}),b(document).bind("TextInput",function(){b(".transient",vorple.parser._container.vorple).animate({opacity:0},1500).slideUp(500,function(){b(this).remove()});vorple.parser.scrollPosition=b(document).scrollTop();vorple.parser.setTurnType("normal")}),b(document).bind("TurnComplete",function(){var a=b(".main",vorple.parser._container.parchment),d=b(vorple.parser._container.vorple);b(".lastinput",d).parent().find("br");0<b(".currentPrompt",d).find("br").length&&b(".turn:last .turnContent").append(b("<br>"));
var c=b(".lastinput",d).parent().text(),e=b("span",a).first().contents().first().text(),c=b("<div>").html(c+e).addClass("oldPrompt");b(".lastinput",d).parent().remove();b("span",a).first().contents().first().remove();b("span",a).first().contents().first().remove();$newTurn=b("<div>").append(c);$turnContent=b("<div>").addClass("turnContent").append(a.contents()).appendTo($newTurn);b(".currentPrompt").remove();$currentPrompt=b("<div>").addClass("currentPrompt").addClass("promptContainer");$turnContent.find("span:last").appendTo($currentPrompt);
a.empty();vorple.parser.setTurnClasses($newTurn)&&(b(".penultimateTurn").removeClass("penultimateTurn"),b(".previousTurn").addClass("penultimateTurn").removeClass("previousTurn").addClass("previousTurnFader").removeClass("previousTurnFader",1E3),$newTurn.addClass("previousTurn"));$newTurn.addClass("turn");d.append($newTurn).append($currentPrompt);b(document).scrollTop(vorple.parser.scrollPosition);a=b(document).height()-b(window).height();a-b(window).height()>vorple.parser.scrollPosition&&(a=b(window).height()+
vorple.parser.scrollPosition-100);b("html, body").animate({scrollTop:a},150);b(".TextInput").width(b(vorple.parser._container.vorple).width()-20)}))})})(jQuery);(function(b){vorple.tabs={};vorple.tabs.create=function(a){var d=a;if("object"!=typeof a||!a.jquery)d=b(a);if(!b.tabs)throw Error("jQuery UI tabs is not installed");return d.tabs()}})(jQuery);(function(b){vorple.tooltip={};vorple.tooltip.defaults={show:{event:"mouseenter",ready:!1},content:{attr:"title"},position:{my:"bottom left",at:"top center"},overwrite:!1,delay:3E3,duration:1E4};vorple.tooltip._create=function(a,d){var c=b.extend({},this.defaults,d),e=b(a);!c.content&&e.attr(c.content.attr);c.content&&e.qtip(c);return e};vorple.tooltip.enable=function(a,d){var c=this,e=b.extend(!0,{},c.defaults,{show:{ready:!0,event:c.defaults.show.event}},d);return b(document).delegate(a,e.show.event,
...
b,c,e);return!1};vorple.undum.dispose=function(){var a=this;b.each(arguments,function(d,c){if(b.isArray(c))b.each(c,function(b,c){a.dispose(c)});else if(!a.isDisposed(c)){var e=c.split("/");undum.game._disposedLinks.push(e[e.length-1]);a._removeDisposed(c)}})};vorple.undum.isDisposed=function(a){return-1<b.inArray(a,undum.game._disposedLinks)};vorple.undum.reactivate=function(){var a=this;b.each(arguments,function(d,c){if(b.isArray(c))b.each(c,function(b,c){a.reactivate(c)});else{var e=c.split("/"),
e=b.inArray(e[e.length-1],undum.game._disposedLinks);-1<e&&undum.game._disposedLinks.splice(e,1)}})};b(document).bind("vorpleInit",function(){if(vorple.core.engine("undum")&&(undum.game.afterEnter||(undum.game.afterEnter=function(a,b,c,e){return vorple.undum.afterEnterTrigger(a,b,c,e)}),undum.game.afterAction||(undum.game.afterAction=function(a,b,c,e){return vorple.undum.afterActionTrigger(a,b,c,e)}),"undefined"===typeof undum.game._disposedLinks))undum.game._disposedLinks=[]})})(jQuery);
