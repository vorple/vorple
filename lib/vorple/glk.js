...
}, _defineProperty(_GLK, "fatal_error", fatal_error), _defineProperty(_GLK, "byte_array_to_string", ByteArrayToString), _defineProperty(_GLK, "uni_array_to_string", UniArrayToString), _defineProperty(_GLK, "Const", _glkConstants.Const), _defineProperty(_GLK, "RefBox", RefBox), _defineProperty(_GLK, "RefStruct", RefStruct), _defineProperty(_GLK, "DidNotReturn", DidNotReturn), _defineProperty(_GLK, "call_may_not_return", call_may_not_return), _defineProperty(_GLK, "glk_put_jstring", glk_put_jstring), _defineProperty(_GLK, "glk_put_jstring_stream", glk_put_jstring_stream), _defineProperty(_GLK, "glk_exit", glk_exit), _defineProperty(_GLK, "glk_tick", glk_tick), _defineProperty(_GLK, "glk_gestalt", glk_gestalt), _defineProperty(_GLK, "glk_gestalt_ext", glk_gestalt_ext), _defineProperty(_GLK, "glk_window_iterate", glk_window_iterate), _defineProperty(_GLK, "glk_window_get_rock", glk_window_get_rock), _defineProperty(_GLK, "glk_window_get_root", glk_window_get_root), _defineProperty(_GLK, "glk_window_open", glk_window_open), _defineProperty(_GLK, "glk_window_get_type", glk_window_get_type), _defineProperty(_GLK, "glk_window_get_parent", glk_window_get_parent), _defineProperty(_GLK, "glk_window_get_stream", glk_window_get_stream), _defineProperty(_GLK, "glk_window_set_echo_stream", glk_window_set_echo_stream), _defineProperty(_GLK, "glk_window_get_echo_stream", glk_window_get_echo_stream), _defineProperty(_GLK, "glk_set_window", glk_set_window), _defineProperty(_GLK, "glk_window_get_sibling", glk_window_get_sibling), _defineProperty(_GLK, "glk_stream_iterate", glk_stream_iterate), _defineProperty(_GLK, "glk_stream_get_rock", glk_stream_get_rock), _defineProperty(_GLK, "glk_stream_open_file", glk_stream_open_file), _defineProperty(_GLK, "glk_stream_open_memory", glk_stream_open_memory), _defineProperty(_GLK, "glk_stream_close", glk_stream_close), _defineProperty(_GLK, "glk_stream_set_position", glk_stream_set_position), _defineProperty(_GLK, "glk_stream_get_position", glk_stream_get_position), _defineProperty(_GLK, "glk_stream_set_current", glk_stream_set_current), _defineProperty(_GLK, "glk_stream_get_current", glk_stream_get_current), _defineProperty(_GLK, "glk_fileref_create_by_name", glk_fileref_create_by_name), _defineProperty(_GLK, "glk_fileref_create_by_prompt", glk_fileref_create_by_prompt), _defineProperty(_GLK, "glk_fileref_destroy", glk_fileref_destroy), _defineProperty(_GLK, "glk_fileref_iterate", glk_fileref_iterate), _defineProperty(_GLK, "glk_fileref_get_rock", glk_fileref_get_rock), _defineProperty(_GLK, "glk_fileref_does_file_exist", glk_fileref_does_file_exist), _defineProperty(_GLK, "glk_fileref_create_from_fileref", glk_fileref_create_from_fileref), _defineProperty(_GLK, "glk_put_char", glk_put_char), _defineProperty(_GLK, "glk_put_char_stream", glk_put_char_stream), _defineProperty(_GLK, "glk_put_string", glk_put_string), _defineProperty(_GLK, "glk_put_string_stream", glk_put_string_stream), _defineProperty(_GLK, "glk_put_buffer", glk_put_buffer), _defineProperty(_GLK, "glk_put_buffer_stream", glk_put_buffer_stream), _defineProperty(_GLK, "glk_set_style", glk_set_style), _defineProperty(_GLK, "glk_set_style_stream", glk_set_style_stream), _defineProperty(_GLK, "glk_get_char_stream", glk_get_char_stream), _defineProperty(_GLK, "glk_get_line_stream", glk_get_line_stream), _defineProperty(_GLK, "glk_get_buffer_stream", glk_get_buffer_stream), _defineProperty(_GLK, "glk_char_to_lower", glk_char_to_lower), _defineProperty(_GLK, "glk_char_to_upper", glk_char_to_upper), _defineProperty(_GLK, "glk_stylehint_set", DO_NOTHING), _defineProperty(_GLK, "glk_stylehint_clear", DO_NOTHING), _defineProperty(_GLK, "glk_select", glk_select), _defineProperty(_GLK, "glk_request_line_event", glk_request_line_event), _defineProperty(_GLK, "glk_request_char_event", glk_request_char_event), _defineProperty(_GLK, "glk_cancel_char_event", glk_cancel_char_event), _defineProperty(_GLK, "glk_schannel_iterate", DO_NOTHING), _defineProperty(_GLK, "glk_buffer_to_lower_case_uni", glk_buffer_to_lower_case_uni), _defineProperty(_GLK, "glk_buffer_to_upper_case_uni", glk_buffer_to_upper_case_uni), _defineProperty(_GLK, "glk_buffer_to_title_case_uni", glk_buffer_to_title_case_uni), _defineProperty(_GLK, "glk_buffer_canon_decompose_uni", glk_buffer_canon_decompose_uni), _defineProperty(_GLK, "glk_buffer_canon_normalize_uni", glk_buffer_canon_normalize_uni), _defineProperty(_GLK, "glk_put_char_uni", glk_put_char_uni), _defineProperty(_GLK, "glk_put_string_uni", glk_put_string_uni), _defineProperty(_GLK, "glk_put_buffer_uni", glk_put_buffer_uni), _defineProperty(_GLK, "glk_put_char_stream_uni", glk_put_char_stream_uni), _defineProperty(_GLK, "glk_put_string_stream_uni", glk_put_string_stream_uni), _defineProperty(_GLK, "glk_put_buffer_stream_uni", glk_put_buffer_stream_uni), _defineProperty(_GLK, "glk_get_char_stream_uni", glk_get_char_stream_uni), _defineProperty(_GLK, "glk_get_buffer_stream_uni", glk_get_buffer_stream_uni), _defineProperty(_GLK, "glk_get_line_stream_uni", glk_get_line_stream_uni), _defineProperty(_GLK, "glk_stream_open_memory_uni", glk_stream_open_memory_uni), _defineProperty(_GLK, "glk_request_char_event_uni", glk_request_char_event_uni), _defineProperty(_GLK, "glk_request_line_event_uni", glk_request_line_event_uni), _defineProperty(_GLK, "glk_set_echo_line_event", glk_set_echo_line_event), _defineProperty(_GLK, "glk_set_terminators_line_event", glk_set_terminators_line_event), _defineProperty(_GLK, "glk_current_time", glk_current_time), _defineProperty(_GLK, "glk_current_simple_time", glk_current_simple_time), _defineProperty(_GLK, "glk_time_to_date_utc", glk_time_to_date_utc), _defineProperty(_GLK, "glk_time_to_date_local", glk_time_to_date_local), _defineProperty(_GLK, "glk_simple_time_to_date_utc", glk_simple_time_to_date_utc), _defineProperty(_GLK, "glk_simple_time_to_date_local", glk_simple_time_to_date_local), _defineProperty(_GLK, "glk_date_to_time_utc", glk_date_to_time_utc), _defineProperty(_GLK, "glk_date_to_time_local", glk_date_to_time_local), _defineProperty(_GLK, "glk_date_to_simple_time_utc", glk_date_to_simple_time_utc), _defineProperty(_GLK, "glk_date_to_simple_time_local", glk_date_to_simple_time_local), _defineProperty(_GLK, "sendChar", sendChar), _defineProperty(_GLK, "sendLine", sendLine), _GLK);
