...
module.exports = function( config ) {
    config.set( {
        ...
        files: [
            'release/lib/vorple.3rdparty-bundle.min.js',
            'vendor/parchment.min.js',
            'vendor/undum.js',
            // must list all source files separately because patterns
            // make it recurse into I7 extension directory where it throws
            // an error because I have another git repo there
            'src/vorple.core.js',
            'src/vorple.cookie.js',
            'src/vorple.html.js',
            'src/vorple.media.js',
            'src/vorple.notify.js',
            'src/vorple.parser.js',
            'src/vorple.tooltip.js',
            'src/vorple.undum.js',
            'tests/test-setup.js',
